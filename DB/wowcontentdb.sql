...
START TRANSACTION;
USE `wowcontentdb`;
INSERT INTO `content` (`id`, `name`, `description`, `image_url`, `created_date`, `user_id`, `last_update`, `content_category_id`, `enabled`) VALUES (1, 'Slay the defiler', 'the defiler is attacking the village', 'image', '2024-03-04', 1, '2024-03-04', 1, 1);
INSERT INTO `content` (`id`, `name`, `description`, `image_url`, `created_date`, `user_id`, `last_update`, `content_category_id`, `enabled`) VALUES (2, 'Shadow - Flying Dark Horse', 'huge dark mount with wings', 'image', '2024-03-04', 1, '2024-03-04', 2, 1);
...
INSERT INTO `content` (`id`, `name`, `description`, `image_url`, `created_date`, `user_id`, `last_update`, `content_category_id`, `enabled`) VALUES (4, 'History of Dwarfs', 'dwarfs began many years ago ......', 'image', '2024-03-04', 1, '2024-03-04', 4, 1);
INSERT INTO `content` (`id`, `name`, `description`, `image_url`, `created_date`, `user_id`, `last_update`, `content_category_id`, `enabled`) VALUES (5, 'Moonlight Staff', 'long radiant metallic staff', 'image', '2024-03-04', 1, '2024-03-04', 5, 1);
INSERT INTO `content` (`id`, `name`, `description`, `image_url`, `created_date`, `user_id`, `last_update`, `content_category_id`, `enabled`) VALUES (6, 'Dragonic Chestplate', 'blackend chard and spiked plate chestpiece', 'image', '2024-03-04', 1, '2024-03-04', 6, 1);
INSERT INTO `content` (`id`, `name`, `description`, `image_url`, `created_date`, `user_id`, `last_update`, `content_category_id`, `enabled`) VALUES (7, 'Land of Emeralds', 'a shimmering gem land with elfs and gem creature', 'image', '2024-03-04', 1, '2024-03-04', 7, 1);
INSERT INTO `content` (`id`, `name`, `description`, `image_url`, `created_date`, `user_id`, `last_update`, `content_category_id`, `enabled`) VALUES (8, 'Raid - StormBreach', 'two team charge the breach', 'image', '2024-03-04', 1, '2024-03-04', 8, 1);
INSERT INTO `content` (`id`, `name`, `description`, `image_url`, `created_date`, `user_id`, `last_update`, `content_category_id`, `enabled`) VALUES (9, 'More dungeons ', 'i want more dungeons in the world', 'image', '2024-03-04', 1, '2024-03-04', 9, 1);
INSERT INTO `content` (`id`, `name`, `description`, `image_url`, `created_date`, `user_id`, `last_update`, `content_category_id`, `enabled`) VALUES (10, 'FishTank', 'player can have a pet fish in a tank the they haul around on their mount', 'image', '2024-03-04', 1, '2024-03-04', 10, 1);
INSERT INTO `content` (`id`, `name`, `description`, `image_url`, `created_date`, `user_id`, `last_update`, `content_category_id`, `enabled`) VALUES (11, 'NightGuard', 'a class that uses shadow magic, pets, and stealth', 'image', '2024-03-04', 1, '2024-03-04', 11, 1);
INSERT INTO `content` (`id`, `name`, `description`, `image_url`, `created_date`, `user_id`, `last_update`, `content_category_id`, `enabled`) VALUES (12, 'Tigeraria', 'a race of tigers', 'image', '2024-03-04', 1, '2024-03-04', 12, 1);
INSERT INTO `content` (`id`, `name`, `description`, `image_url`, `created_date`, `user_id`, `last_update`, `content_category_id`, `enabled`) VALUES (13, 'Whirlwind', 'a talent that attacks all enemies nearby', 'image', '2024-03-04', 1, '2024-03-04', 13, 1);
INSERT INTO `content` (`id`, `name`, `description`, `image_url`, `created_date`, `user_id`, `last_update`, `content_category_id`, `enabled`) VALUES (14, 'The Trench', 'a battleground of trenches ', 'image', '2024-03-04', 1, '2024-03-04', 14, 1);
INSERT INTO `content` (`id`, `name`, `description`, `image_url`, `created_date`, `user_id`, `last_update`, `content_category_id`, `enabled`) VALUES (15, 'PvP Arena', 'a pvp arena', 'image', '2024-03-04', 1, '2024-03-04', 15, 1);
INSERT INTO `content` (`id`, `name`, `description`, `image_url`, `created_date`, `user_id`, `last_update`, `content_category_id`, `enabled`) VALUES (16, 'Yismere', 'a npc that guides your through early game content if you want', 'image', '2024-03-04', 1, '2024-03-04', 16, 1);
INSERT INTO `content` (`id`, `name`, `description`, `image_url`, `created_date`, `user_id`, `last_update`, `content_category_id`, `enabled`) VALUES (17, 'Castle Lochrim', 'a dungeon with many bosses and hordes of enemies', 'image', '2024-03-04', 1, '2024-03-04', 17, 1);
INSERT INTO `content` (`id`, `name`, `description`, `image_url`, `created_date`, `user_id`, `last_update`, `content_category_id`, `enabled`) VALUES (18, 'Parcher', 'a enemy of slime and recongifured plant material', 'image', '2024-03-04', 1, '2024-03-04', 18, 1);
INSERT INTO `content` (`id`, `name`, `description`, `image_url`, `created_date`, `user_id`, `last_update`, `content_category_id`, `enabled`) VALUES (19, 'Gardening', 'the profession to grow fruits and vegatables', 'image', '2024-03-04', 1, '2024-03-04', 19, 1);
INSERT INTO `content` (`id`, `name`, `description`, `image_url`, `created_date`, `user_id`, `last_update`, `content_category_id`, `enabled`) VALUES (20, 'Random Idea', 'how about all players have the options to start at the lvl they want', 'image', '2024-03-04', 1, '2024-03-04', 20, 1);
INSERT INTO `content` (`id`, `name`, `description`, `image_url`, `created_date`, `user_id`, `last_update`, `content_category_id`, `enabled`) VALUES (21, 'New BUG', 'found a bug i spawn in the ocean ', 'image', '2024-03-04', 1, '2024-03-04', 21, 1);
