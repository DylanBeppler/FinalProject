package com.skilldistillery.wowcontent.security;
    ...
    SecurityFilterChain createFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(
          authorize -> authorize
            ...
            .requestMatchers(HttpMethod.GET, "/api/categories").permitAll()     // will hit the OPTIONS on the route
            .requestMatchers(HttpMethod.GET, "/api/content").permitAll()     // will hit the OPTIONS on the route
